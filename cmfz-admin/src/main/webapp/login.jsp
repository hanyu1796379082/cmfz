			...
			$("#captchaImage").click(function(){//点击更换验证码
				$.ajax({
					...
					success:function(message){
                        $("#captchaImage").attr("src","mgr/getImg");
					}
				})
			});
...
<body>
		...
		<div class="login">
			<form id="loginForm" action="mgr/login" method="post" >
				<%--<p style="float: right;color: red">${massage }</p>--%>
					<p style="float: right;color: red">${massage}</p>
				<table>
					<tbody>
						<tr>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="mgr/getImg"  title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
						...
						<td>
							<label>
								<input type="checkbox" id="isRememberUsername"  name="status"/> 记住用户名
							</label>
						</td>
					</tr>
					<tr>
